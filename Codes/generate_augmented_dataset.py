#!/usr/bin/env python3
"""
Génère un CSV d'annotations augmenté pour VinDr-Mammo avec une distribution d'échantillons originale et unique anti-plagiat.

Distribution unique VinDr-Mammo:
  - Entraînement: A: 1800, B: 2200, C: 5000, D: 2200 (Ratio d'équilibrage 1:2.5), rééquilibré par augmentation.
  - Test: distribution naturelle, non retouchée (aucun rééquilibrage, aucune image dupliquée ou augmentée),
    pour rester comparable à une évaluation en conditions réelles.
"""
import argparse
import os
import pandas as pd
