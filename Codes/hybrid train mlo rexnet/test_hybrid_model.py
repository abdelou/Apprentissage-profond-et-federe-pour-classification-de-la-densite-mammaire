...
print(f"Poids résolus dynamiquement à : {DEFAULT_WEIGHTS_PATH}")
...
print(f"Lignes CSV split=test (vue MLO): {len(df_test)}")
test_dataset = HybridMammographyDataset(df_test, IMAGE_ROOT, CLASS_MAP)
print(f"len(test_dataset): {len(test_dataset)}")
test_loader = DataLoader(test_dataset, batch_size=BATCH_SIZE, shuffle=False)
print(f"Nombre de batches attendus: {len(test_loader)} (batch_size={BATCH_SIZE})")
