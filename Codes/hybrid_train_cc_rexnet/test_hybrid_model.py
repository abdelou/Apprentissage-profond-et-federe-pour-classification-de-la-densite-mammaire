...
BEST_WEIGHTS_PATH = "featuresfinetuned_weights/hybrid_model_best_rexnet150_cc.pth"
...
def main():
    print(f"=== Évaluation Finale du Modèle ReXNet150 sur Vues CC (Figure 16) ===")
    ...
    print("\n=== RÉSULTATS DU TEST FINAL (ReXNet150 CC) ===")
    print(report)
