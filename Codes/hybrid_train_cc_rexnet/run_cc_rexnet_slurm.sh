#!/bin/bash
#SBATCH --job-name=train_cc_rexnet
...
echo "=== Démarrage SLURM Job pour ReXNet150 Vues CC (5 époques express) ==="
date
hostname
...
# Exécuter l'entraînement sur GPU avec support de reprise automatique
