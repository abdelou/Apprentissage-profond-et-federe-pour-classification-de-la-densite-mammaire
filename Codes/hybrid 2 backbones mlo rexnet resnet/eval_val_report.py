...
validation pour la figure entrainement.png (le script d'entrainement
n'affiche que l'accuracy scalaire par epoque, pas de matrice).
"""
import sys
import pandas as pd
import numpy as np
...
print(f"[INFO] {len(val_dataset)} images de validation ({view}, {tag})")
