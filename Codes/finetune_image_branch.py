...
VINDR_ROOT = '/Volumes/cimobile/Entrainement_cetic/vindr-mammo_dataset/physionet.org/files/vindr-mammo/1.0.0'
CONFIG = {
    ...
    def _train_model(self, model, train_loader, val_loader, epochs=30, lr=1e-4,
        ...
        for epoch in range(epochs):
            ...
            if val_acc > best_val_acc + min_delta:
                ...
                best_model_path = os.path.join(save_dir, f'{backbone_name}_image_branch_best_MLO.pth')
                model.save_finetuned_weights(best_model_path)
                
                # Sauvegarde du checkpoint pour reprise
                checkpoint_path = os.path.join(save_dir, f'{backbone_name}_image_branch_checkpoint_MLO.pth')
                torch.save({
        ...
        # Sauvegarde finale
        backbone_name = model.backbone
        final_save_path = os.path.join(save_dir, f'{backbone_name}_image_branch_final_MLO.pth')
        ...
        print(f"  - Meilleur modèle: {os.path.join(save_dir, f'{backbone_name}_image_branch_best_MLO.pth')}")
