...
def test_single_dicom(image_path: str):
    """
...
def generate_comparison_figure(image_path: str, output_filename: str):
    """
...
if __name__ == '__main__':
    ...
    if os.path.exists(base_dir):
        print("[INFO] Recherche d'exemples MONOCHROME1 et MONOCHROME2 dans le dataset...")
    ...
    if mono1_path:
        print(f"[INFO] Image MONOCHROME1 trouvée: {mono1_path}")
        generate_comparison_figure(mono1_path, 'figure6_monochrome1.png')
        
    if mono2_path:
        print(f"[INFO] Image MONOCHROME2 trouvée: {mono2_path}")
